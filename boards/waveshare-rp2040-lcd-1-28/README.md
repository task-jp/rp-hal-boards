...
a 1.28inch LCD round display, Li-ion battery charger, 6-axis sensor (3-axis accelerometer and 3-axis gyroscope) and so on from Waveshare.
...
[waveshare-rp2040-lcd-1-28]: https://github.com/rp-rs/rp-hal-boards/tree/main/boards/waveshare-rp2040-lcd-1-18
...
```toml
waveshare_rp2040_lcd_1_28 = "0.7.0"
```
